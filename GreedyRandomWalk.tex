...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \fbox{ \color{red}    \begin{tabular}{l}
         PROVE why this is true!!! \\
         Note that conditioning on $k$ and $B_j$'s might change the escape time. \\
         Also might be that not every fixing is possible, i.e. has zero probability!!!
    \end{tabular}    }
    \[
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \fbox{ \color{red}    \begin{tabular}{l}
        explain how this can be turned into a DFS walk
    \end{tabular}    }
